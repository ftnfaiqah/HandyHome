            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark"
                            href="{{ route('invoice.index') }}">Invois</a></li>
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Menjana Invois</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Menjana Invois</h6>
            </nav>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="button-row d-flex mt-4 col-12">
                                    <button onclick="window.location.href='{{ route('invoice.index') }}'"
