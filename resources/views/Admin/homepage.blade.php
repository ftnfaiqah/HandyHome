        ...
        document.addEventListener('DOMContentLoaded', function() {
            if (document.querySelector('[data-toggle="widget-calendar"]')) {
                ...
                var calendar = new FullCalendar.Calendar(calendarEl, {
                    ...
                    selectable: true,
                    initialDate: today.toISOString().split('T')[0], // Set initial date to today
                    editable: true,
                    headerToolbar: {
                    ...
                    events: [{
                        ...
                        {
                            title: '9:00 a.m Site visit',
                            start: '2024-06-20',
                            end: '2024-06-20',
                            className: 'bg-secondary'
                        },
                        {
                            title: '2:00 p.m Site visit',
                            start: '2024-06-20',
                            end: '2024-06-20',
                            className: 'bg-secondary'
                        },
                        {
                            title: '12:00 p.m Site visit',
                            start: '2024-06-05',
                            end: '2024-06-05',
                            className: 'bg-secondary'
                        },
                        {
                            title: '04:00 p.m Site visit',
                            start: '2024-06-05',
                            end: '2024-06-05',
                            className: 'bg-secondary'
                        }
