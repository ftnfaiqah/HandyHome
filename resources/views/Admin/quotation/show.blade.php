            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark"
                            href="{{ route('quotation.index') }}">Sebut Harga</a></li>
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Papar Sebut Harga</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Papar Sebut Harga</h6>
            </nav>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="button-row d-flex mt-4 col-12">
                                    <button  onclick="window.location.href='{{ route('quotation.index') }}'" class="btn bg-gradient-light mb-0 js-btn-prev" type="button"
                                        title="Kembali">Kembali</button>
                                    <button onclick="window.location.href='{{ route('quotation.index') }}'" class="btn btn-warning ms-auto mb-0" type="button"
                                        title="Maklum">Maklum</button>
                                </div>
                            </div> 
