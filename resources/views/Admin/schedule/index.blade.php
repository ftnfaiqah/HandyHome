        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Jadual Kerja</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Jadual Kerja</h6>
            </nav>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="eventForm">
                        <div class="mb-3">
                            <label for="eventTitle" class="form-label">Tajuk</label>
                        ...
                        <div class="mb-3">
                            <label for="endDate" class="form-label">Tarikh Tamat</label>
                            <input type="date" class="form-control" id="endDate">
                        </div>
                        <div class="d-flex justify-content-between">
                            <button type="button" class="btn btn-danger me-2" id="deleteEventButton" style="display: none;">Hapus</button>
            ...
            if (document.querySelector('[data-toggle="widget-calendar"]')) {
                ...
                var calendar = new FullCalendar.Calendar(calendarEl, {
                    ...
                    eventClick: function(info) {
                        ...
                        document.getElementById('endDate').value = info.event.endStr || info.event.startStr;
