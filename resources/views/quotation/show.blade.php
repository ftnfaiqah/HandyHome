                        ...
                        <div class="card-body">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-sm-5">
                                    <div class="mt-3 float-sm-right">
                                        <p><strong>Tarikh Sebut Harga: </strong> Ogos 5, 2023</p>
                                        <p><strong>No. Tempahan: </strong> <span class="float-right">#123456</span></p>
                                    </div>
                                </div> <!-- end col-->
                                        ...
                                        <table class="table text-right">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="ps-4">Tukar pintu bilik air</td>
                                                    <td class="ps-4">3</td>
                            ...
                            <div class="row">
                                <div class="button-row d-flex mt-4 col-12">
                                    ...
                                    <button onclick="window.location.href='{{ route('booking.index') }}'"
