        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Sebut Harga</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Sebut Harga</h6>
            </nav>
                                ...
                                <table class="table table-flush" id="products-list">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-sm">
                                                <a href="{{ route('quotation.view') }}" data-bs-toggle="tooltip"
                                                    data-bs-original-title="Papar">
                                                    <i class="fas fa-eye text-dark m-2"></i>
                                                </a>
                                                <a href="{{ route('quotation.create') }}" class="mx-3"
                                                    data-bs-toggle="tooltip" data-bs-original-title="Tambah">
                                                    <i class="fas fa-plus text-dark"></i>
                                                </a>

                                                <a href="{{ route('quotation.edit') }}" data-bs-toggle="tooltip"
                                                    data-bs-original-title="Kemaskini" class="disabled-link">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-sm">
                                                ...
                                                <a href="{{ route('quotation.create') }}" class="mx-3 disabled-link"
                                                    data-bs-toggle="tooltip" data-bs-original-title="Tambah">
